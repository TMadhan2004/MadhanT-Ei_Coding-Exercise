...
import ex2.core.Priority;
import ex2.core.Task;
import ex2.factory.TaskFactory;
import ex2.manager.ScheduleManager;
...
public class ConsoleController 
{
    ...
    private void viewTasks() 
    {
        ...
        {
            for (Task t : tasks) System.out.println(formatTask(t));
            System.out.println();
        }
    }
    ...
    private void editTask(Scanner sc) 
    {
        ...
        try 
        {
            ...
            if (keepCompleted) manager.completeTask(newTask.getDescription());
